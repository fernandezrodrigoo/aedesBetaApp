      ...
      map.on('click', function(evt) {
		...
		var perfil = document.getElementById("perfil").value;	
		  ...
		  var json = {"items": [
		 {
		   "zona": "Zona: " + feature.get('secundaria'),
		   ...
		   "as": "Área suelo: " + feature.get('as'),
		   "at": "Área total: " + feature.get('at'),
		   "av": "Área verde: " + feature.get('av'),
		   "ass": "Área subsuelo: " + feature.get('ass'),			 
		   "viv": "Viviendas máx.: " + feature.get('viv_max'),	
			 
			 
		   "pob": "Personas (max): " + (feature.get('viv_max') * perfil),
		   "res": "Residuos (max): " + (feature.get('viv_max') * perfil * 0.81) + " kg/día",
		   "elec": "Electricidad (max): " + (feature.get('viv_max') * perfil * 3193) + " kw/hora",
		   "agua": "Agua (max): " + (feature.get('viv_max') * perfil * 130) + " lts/día",	 
