        ...
        <div class="col-md-12">
		  ...
		  <div class="box-body" >			  
			  <?php
				...
				$sql = "UPDATE \"ModUrb\".\"costaplan_normativa_propuesta\" SET (fos, fot, foss, fov, m2xviv, ret_front, ret_lateral, ret_fond, hmax, niveles) = ('$fos', '$fot', '$foss', '$fov', '$m2xviv', '$ret_front', '$ret_later', '$ret_fond', '$h_max', '$niveles') WHERE normativa = '$zona'";
