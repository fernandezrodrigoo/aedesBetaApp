...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        CostaPlan
        <small>Resumen del cambio de prevalencias tipológicas CostaPlan centro</small>
      </h1>
        ...
        <div class="col-md-12">
		  ...
		  <div class="box-body" >			  
			  <?php
				...
				$sql1 = 
				"UPDATE \"ModUrb\".\"costaplan_prev_tipos_centro\" SET prevalencia = $tipo1 WHERE tipo = 'tipo1a'";
			  	$sql2 = 
				"UPDATE \"ModUrb\".\"costaplan_prev_tipos_centro\" SET prevalencia = $tipo2 WHERE tipo = 'tipo2a'";
				$sql3 = 
				"UPDATE \"ModUrb\".\"costaplan_prev_tipos_centro\" SET prevalencia = $tipo3 WHERE tipo = 'tipo3a'";
			  	$sql4 = 
				"UPDATE \"ModUrb\".\"costaplan_prev_tipos_centro\" SET prevalencia = $tipo4 WHERE tipo = 'tipo4a'";
			    $sql5 = 
				"UPDATE \"ModUrb\".\"costaplan_prev_tipos_centro\" SET prevalencia = $tipo5 WHERE tipo = 'tipo5a'";


				$frentes = pg_query($sql1) or die('La actualización de frentes falló: ' . pg_last_error());
			  	$lados = pg_query($sql2) or die('La actualización de lados falló: ' . pg_last_error());
			  	$frentefondos = pg_query($sql3) or die('La actualización de fondos falló: ' . pg_last_error());
			  	$fondos = pg_query($sql4) or die('La actualización vacíos falló: ' . pg_last_error());
			    $vacios = pg_query($sql5) or die('La actualización vacíos falló: ' . pg_last_error());
			  
			  	$consulta = "SELECT tipo_nombre, prevalencia FROM \"ModUrb\".\"costaplan_prev_tipos_centro\"";

				$consultar = pg_query($consulta) or die('La consulta fallo: ' . pg_last_error());
			  ...
			  <a href="edicioncosta.php" class="btn btn-default btn-rounded mb-4">Volver
              </a>
