...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        CostaPlan
        <small>Resumen del cambio de prevalencias tipológicas CostaPlan sur</small>
      </h1>
        ...
        <div class="col-md-12">
		  ...
		  <div class="box-body" >			  
			  <?php
				...
				$sql1 = 
				"UPDATE \"ModUrb\".\"costaplan_prev_tipos_sur\" SET prevalencia = $tipo1 WHERE tipo = 'tipo1a'";
			  	$sql2 = 
				"UPDATE \"ModUrb\".\"costaplan_prev_tipos_sur\" SET prevalencia = $tipo2 WHERE tipo = 'tipo2a'";
				$sql3 = 
				"UPDATE \"ModUrb\".\"costaplan_prev_tipos_sur\" SET prevalencia = $tipo3 WHERE tipo = 'tipo3a'";
			  	$sql4 = 
				"UPDATE \"ModUrb\".\"costaplan_prev_tipos_sur\" SET prevalencia = $tipo4 WHERE tipo = 'tipo4a'";
			    $sql5 = 
				"UPDATE \"ModUrb\".\"costaplan_prev_tipos_sur\" SET prevalencia = $tipo5 WHERE tipo = 'tipo5a'";
				...
				$frentes = pg_query($sql1) or die('La actualización de frentes falló: ' . pg_last_error());
			  	...
			  	$frentefondo = pg_query($sql3) or die('La actualización de fondos falló: ' . pg_last_error());
			  	$fondo = pg_query($sql4) or die('La actualización vacíos falló: ' . pg_last_error());
			    $vacios = pg_query($sql5) or die('La actualización vacíos falló: ' . pg_last_error());
			  
			  	$consulta = "SELECT tipo_nombre, prevalencia FROM \"ModUrb\".\"costaplan_prev_tipos_sur\"";
