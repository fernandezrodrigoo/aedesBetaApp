...
// Capas	  
	var costa_zonas = new ol.layer.Vector({
		style: styleFunction,
        source: new ol.source.Vector({
        url: function(extent) {
          return 'http://geoserver.fadu.edu.uy:8080/geoserver/apps/wfs?service=WFS&' +
              'version=1.0.0&request=GetFeature&typeName=apps:costaplan_zonas&' +
