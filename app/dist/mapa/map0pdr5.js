...
// Capas	  
	var costa_normativar = new ol.layer.Vector({
        source: new ol.source.Vector({
        url: function(extent) {
          return 'http://geoserver.fadu.edu.uy:8080/geoserver/apps/wfs?service=WFS&' +
              'version=1.0.0&request=GetFeature&typeName=apps:costaplan_cat_secundaria&' +
...
// define los colores y el nombre de los rangos
      ...
      var d = [2,50,95, 0.8];
      var e = [2,50,95,1];
      var f = [244,246,245, 0.8];
      var g = [244,246,245, 0.8];
...
//Mapa
	var map = new ol.Map({
		target: 'map',  
		renderer: 'canvas', 
		layers: [BaseNeutra, costa_normativar],     
		view: new ol.View({
