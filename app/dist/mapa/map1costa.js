...
// Capas	  
        ...
        url: function(extent) {
          return 'http://geoserver.fadu.edu.uy:8080/geoserver/apps/wfs?service=WFS&' +      'version=1.0.0&request=GetFeature&typeName=apps:costaplan_terreno_util_propuesta_sur&' + 'outputFormat=application/json' ;
        },
	...
	map.addLayer(costa_terreno_sur_propuesta);
        ...
        url: function(extent) {
          return 'http://geoserver.fadu.edu.uy:8080/geoserver/apps/wfs?service=WFS&' +
              'version=1.0.0&request=GetFeature&typeName=apps:costaplan_terreno_util_sur&' +
